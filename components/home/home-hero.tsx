  ...
  return (
    <HeroCarousel
      slides={banners.map((b) => ({
        ...
        scrim: b.scrim,
        mobileTextColor: b.mobileTextColor,
        mobileTextPosition: b.mobileTextPosition,
        mobileTextVAlign: b.mobileTextVAlign,
        mobileScrim: b.mobileScrim,
        hideTextOnMobile: b.hideTextOnMobile,
        headline: b.headline,
